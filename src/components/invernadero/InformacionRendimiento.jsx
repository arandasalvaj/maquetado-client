...
const Informacion = () => {
  return (
    <div className=" grid grid-cols-3 gap-4 px-8 py-4 grid-flow-cols-dense">
        <div className="bg-green-400 rounded-lg shadow-sm min-h-[100px] col-span-3 sm:col-span-2 row-span-3 flex items-center justify-center"> 
            <div className="py-16 sm:py-0">
                <h1 className='text-5xl text-white font-bold text-center'>UBICACIÓN</h1>
                <p className='text-2xl text-white  text-center grid grid-rows-2'>PALQUI #4401</p>
            </div>  
        </div>
